        ...
        <tr>
  		...
  		<table cellpadding="0" cellspacing="0" id="addtable"> 
	  	            <tr>
	  		            ...
	  		            <td class="right"><input type="text" lay-verify="required" name="type" class="layui-input" value="${teachertype.type}" /></td>
	  	            </tr>
	  	            <tr>
	  		            <td class="left">&nbsp;</td>
...
layui.use(['form', 'layedit', 'laydate','layer'], function(){
   ...
   //监听提交
     form.on('submit(demo1)', function(data){
	       $("#sqlform").form("submit",{
				url : "${basePath}teachertype/add.do?id=${teachertype.id}",
				onSubmit : function() { },
				success : function(result) {
					var result = eval('(' + result + ')');
					if (result.success) {
							$.messager.alert("系统提示", result.mgf, "info", function () {
								location.href='${basePath}teachertype/admin_list.do';
					        }); 
						} else {
