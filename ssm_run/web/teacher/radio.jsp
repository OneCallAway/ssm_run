  ...
  <body>
  	...
  	<table cellpadding="0" cellspacing="0" id="maintable">
        <tr>
            ...
            <button class="layui-btn layui-btn-normal" onclick="location.href='<%=basePath%>radio/addpage.do?newsId=<%=request.getParameter("newsId")%>'">添加</button>
  		<table id="sqltable">
		                <tr class="title">
			               <td>标题</td>
			               <td>难度</td>
		                ...
		                <tr class="rows">
			                ...
			                <td>
				                <a href="<%=basePath %>radio/addpage.do?id=${list.id}">更新</a>
