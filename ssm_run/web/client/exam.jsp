  ...
  <body>
        ...
        <tr>
  		...
  		<table id="sqltable">
		                ...
		                <tr class="rows">
			                ...
			                <td>
				                <a href="javascript:;;" id="${list.id }" class="getexam">考试</a>
			                </td>
		                </tr>
		                </c:forEach>
	                </table>
    ...
    $(function(){ 
    	$(".getexam").click(function(){
    		var id = $(this).attr("id");
		    $.messager.confirm("系统提示", "您确认要考试吗？", function(r) {
		    	//location.href='${basePath}exam/client_show.do?id='+id;
				 if (r) {
					$.post("${basePath}exam/client_getis.do", {
						id:id
					}, function(result) {
						if (result.success) {
							location.href='${basePath}exam/client_show.do?id='+id; 
